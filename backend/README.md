...
Разработанное приложение необходимо обернуть в контейнер посредством Docker Compose.
...
- Убедитесь, что у вас стоит Node.js последней LTS версии: https://nodejs.org/en/ ( как правило четная версия самая стабильная )
...
1. Убедитесь, что у вас стоит последняя node LTS версии. Ссылка для скачивания: https://nodejs.org/en/ ( как правило четная версия самая стабильная )
...
1. Во время разработки приложения не стоит изобретать велосипеды. Для компонентов формы и карточек предусмотрена библиотека `mui-design`.
...
- https://mui.com/ - mui-design
- https://reactrouter.com/ - React router  
- https://www.getpostman.com/ - postman
- https://docs.docker.com/get-started/08_using_compose/#:~:text=Docker%20Compose%20is%20a%20tool,or%20tear%20it%20all%20down. - Docker Compose
